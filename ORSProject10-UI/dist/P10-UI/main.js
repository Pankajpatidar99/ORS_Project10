...
var BaseCtl = /** @class */ (function () {
    ...
    BaseCtl.prototype.search = function () {
        ...
        var _self = this;
        console.log("Search pageNo=", _self.form.pageNo);
        ...
        this.serviceLocator.httpService.post(_self.api.search + "/" + _self.form.pageNo, _self.form.searchParams, function (res) {
            if (res.success) {
                ...
                console.log(_self.form.pageNo);
                console.log(_self.form.index);
            }
            else {
...
var ForgotPasswordComponent = /** @class */ (function () {
    ...
    ForgotPasswordComponent.prototype.submit = function () {
        ...
        this.httpService.get(_self.endpoint + "/fp/" + this.form.loginId, function (res) {
            ...
            //res.result.message = invalid loginID (when false) 
            //res.result.message =Password has been sent to email id (when true)
            ...
            //res.result.inputerror=undefined
...
module.exports = __webpack_require__(/*! C:\Workspace\ORS\ORSProject10-UI\src\main.ts */"./src/main.ts");
