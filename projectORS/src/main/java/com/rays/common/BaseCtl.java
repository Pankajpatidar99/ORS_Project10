...
public abstract class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	 ...
	 * @param session
	 */
	//The purpose of this method is to create and store a user context object that contains information about the current user and make it accessible to other methods and views in the same controller class. This can be useful for implementing authentication, authorization, or other features that depend on the user's identity and preferences.
	...
	public ORSResponse get(@PathVariable long id) {
		System.out.println("BaseCtl Get() method run.......Mr.Pankaj Patidar");
		ORSResponse res = new ORSResponse(true);
	...
	public ORSResponse delete(@PathVariable long id) {
		System.out.println("BaseCtl Delete() method run........Mr.Pankaj Patidar");
		ORSResponse res = new ORSResponse(true);
		try {
	...
	public ORSResponse deleteMany(@PathVariable String[] ids, @RequestParam("pageNo") String pageNo,
			@RequestBody F form) {
		System.out.println("BaseCtl DeleteMany() method....Mr.Pankaj Patidar... run");
		ORSResponse res = new ORSResponse(true);
		try {
...
//			}
			...
			System.out.println("Records Deleted Successfully by Mr.Pankaj Patidar");
	...
	public ORSResponse validate(BindingResult bindingResult) {
		ORSResponse res = new ORSResponse(true);
		System.out.println("inside the validate method of baseCtl. Mr.Pankaj Patidar");
		if (bindingResult.hasErrors()) {
			...
			list.forEach(e -> {
				...
				System.out.println("Mr.Pankaj Patidar.....validate");
